      ...
      submenu: [
        {
          ...
          accelerator: 'F1',
          click: async () => {
            await shell.openExternal('https://github.com/jtdomingo3/Project_Inspire/blob/main/docs/USER_MANUAL.md');
          }
        },
        { type: 'separator' },
        {
          label: 'Project INSPIRE GitHub',
          click: async () => {
            await shell.openExternal('https://github.com/jtdomingo3/Project_Inspire');
          }
        }
      ]
    }
